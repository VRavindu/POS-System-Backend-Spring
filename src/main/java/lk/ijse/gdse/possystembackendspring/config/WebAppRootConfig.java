...
@EnableJpaRepositories(basePackages = "lk.ijse.gdse.possystembackendspring.repository")
...
public class WebAppRootConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        factory.setPackagesToScan("lk.ijse.gdse.possystembackendspring");
